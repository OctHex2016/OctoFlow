const translation = {
  ...
  welcome: 'Benvenuto su OctoFlow, per favore accedi per continuare.',
  ...
  license: {
    tip: 'Prima di avviare OctoFlow Community Edition, leggi su GitHub',
    link: 'Licenza open-source',
  },
  join: 'Unisciti',
  joinTipStart: 'Invitato a unirti al',
  joinTipEnd: 'team su OctoFlow',
  invalid: 'Il link è scaduto',
  explore: 'Esplora OctoFlow',
  ...
  resetPasswordDesc: 'Digita l\'e-mail che hai utilizzato per registrarti su OctoFlow e ti invieremo un\'e-mail per reimpostare la password.',
  ...
  licenseLostTip: 'Impossibile connettersi al server licenze OctoFlow. Contatta il tuo amministratore per continuare a utilizzare OctoFlow.',
  licenseExpired: 'Licenza scaduta',
  licenseLost: 'Licenza persa',
  licenseExpiredTip: 'La licenza OctoFlow Enterprise per la tua area di lavoro è scaduta. Contatta il tuo amministratore per continuare a utilizzare OctoFlow.',
  licenseInactiveTip: 'La licenza OctoFlow Enterprise per la tua area di lavoro è inattiva. Contatta il tuo amministratore per continuare a utilizzare OctoFlow.',
