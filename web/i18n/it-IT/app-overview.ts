const translation = {
  ...
  apiKeyInfo: {
    ...
    tryCloud: 'O prova la versione cloud di OctoFlow con quota gratuita',
  },
  overview: {
    title: 'Panoramica',
    appInfo: {
      ...
      settings: {
        ...
        more: {
          ...
          privacyPolicyTip:
            'Aiuta i visitatori a capire i dati raccolti dall\'applicazione, vedi la <privacyPolicyLink>Privacy Policy</privacyPolicyLink> di OctoFlow.',
      ...
      embedded: {
        ...
        chromePlugin: 'Installa l\'estensione Chrome di OctoFlow Chatbot',
        copied: 'Copiato',
        copy: 'Copia',
      },
      qrcode: {
