const translation = {
  tips: {
    notLoggedIn: 'Questa app vuole accedere al tuo account OctoFlow Cloud',
    loggedIn: 'Questa app vuole accedere alle seguenti informazioni dal tuo account OctoFlow Cloud.',
