const translation = {
  ...
  welcome: 'Dobrodošli v OctoFlow, prosimo, prijavite se za nadaljevanje.',
  ...
  license: {
    tip: 'Preden začnete z OctoFlow Community Edition, preberite GitHub',
    link: 'Licenco odprte kode',
  },
  join: 'Pridruži se',
  joinTipStart: 'Vabimo vas, da se pridružite',
  joinTipEnd: 'ekipi na OctoFlow',
  invalid: 'Povezava je potekla',
  explore: 'Razišči OctoFlow',
  ...
  licenseExpiredTip: 'Licenca za OctoFlow Enterprise za vaš delovni prostor je potekla. Če želite še naprej uporabljati OctoFlow, se obrnite na skrbnika.',
  usePassword: 'Uporaba gesla',
  sendVerificationCode: 'Pošlji kodo za preverjanje',
  resetPasswordDesc: 'Vnesite e-poštni naslov, ki ste ga uporabili za prijavo na OctoFlow, in poslali vam bomo e-poštno sporočilo za ponastavitev gesla.',
  ...
  licenseLostTip: 'Povezava z licenčnim strežnikom OctoFlow ni uspela. Če želite še naprej uporabljati OctoFlow, se obrnite na skrbnika.',
  licenseInactiveTip: 'Licenca OctoFlow Enterprise za vaš delovni prostor je neaktivna. Če želite še naprej uporabljati OctoFlow, se obrnite na skrbnika.',
  webapp: {
