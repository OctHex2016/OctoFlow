const translation = {
  ...
  marketplace: {
    ...
    sortBy: 'Razvrsti po',
    verifiedTip: 'Verificirano s strani OctoFlow',
    discover: 'Odkrijte',
    partnerTip: 'Potrjeno s strani partnerja OctoFlow',
  ...
  difyVersionNotCompatible: 'Trenutna različica OctoFlow ni združljiva s to vtičnico, prosimo, posodobite na minimalno zahtevano različico: {{minimalOctoFlowVersion}}',
