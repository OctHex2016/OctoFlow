const translation = {
  ...
  workspace: {
    manage: '管理工作空間',
    manageDescription: '查看和管理您的所有工作空間。您可以重新命名或刪除您擁有或管理的工作空間。',
    current: '目前',
    plan: '方案',
    renameWorkspace: '重新命名工作空間',
    deleteWorkspace: '刪除工作空間',
    deleteWarning: '此操作將永久刪除工作空間及其所有資料。',
    deleteIsPermanent: '此操作無法撤銷。所有應用程式、資料集和設定將被永久刪除。',
    deleteConfirmation: '您確定要刪除「{{name}}」嗎？',
    cannotDeleteLastWorkspace: '無法刪除您的最後一個工作空間。',
    typeWorkspaceNameToConfirm: '輸入工作空間名稱以確認刪除：',
    enterWorkspaceName: '輸入工作空間名稱',
    switchToManage: '切換到此工作空間以進行管理',
  },
  placeholder: {
    input: '請輸入',
    select: '請選擇',
  ...
  members: {
    ...
    invitationSentTip: '邀請已傳送，對方登入 OctoFlow 後即可訪問你的團隊資料。',
    invitationLink: '邀請連結',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      onTrial: '體驗',
      exhausted: '超出限額',
      desc: '託管 OpenAI 由 OctoFlow 提供的託管 OpenAI 服務，你可以使用 GPT-3.5 等模型，在體驗額度消耗完畢前你需要設定其它模型供應商。',
      callTimes: '呼叫次數',
  ...
  apiBasedExtension: {
    title: 'API 擴充套件提供了一個集中式的 API 管理，在此統一新增 API 配置後，方便在 OctoFlow 上的各類應用中直接使用。',
  ...
  about: {
    changeLog: '更新日誌',
    updateNow: '現在更新',
    nowAvailable: 'OctoFlow {{version}} 現已可用。',
    latestAvailable: 'OctoFlow {{version}} 已是最新版本。',
  },
  appMenus: {
    overview: '監控',
    promptEng: '編排',
