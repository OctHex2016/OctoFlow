const translation = {
  tips: {
    loggedIn: 'Aplikasi ini ingin mengakses informasi berikut dari akun OctoFlow Cloud Anda.',
    notLoggedIn: 'Aplikasi ini ingin mengakses akun OctoFlow Cloud Anda',
