const translation = {
  ...
  license: {
    tip: 'Sebelum memulai Edisi Komunitas OctoFlow, baca GitHub',
  ...
  joinTipEnd: 'tim di OctoFlow',
  dontHave: 'Belum?',
  passwordChangedTip: 'Kata sandi Anda telah berhasil diubah',
  validate: 'Memvalidasi',
  resetPasswordDesc: 'Ketik email yang Anda gunakan untuk mendaftar di OctoFlow dan kami akan mengirimkan email reset kata sandi kepada Anda.',
  licenseLostTip: 'Gagal menghubungkan server lisensi OctoFlow. Hubungi administrator Anda untuk terus menggunakan OctoFlow.',
  signBtn: 'Masuk',
  sendResetLink: 'Kirim tautan reset',
  createAndSignIn: 'Buat dan masuk',
  licenseExpiredTip: 'Lisensi OctoFlow Enterprise untuk ruang kerja Anda telah kedaluwarsa. Hubungi administrator Anda untuk terus menggunakan OctoFlow.',
  email: 'Alamat email',
  noLoginMethodTip: 'Silakan hubungi admin sistem untuk menambahkan metode autentikasi.',
  adminInitPassword: 'Kata sandi inisialisasi admin',
  licenseInactiveTip: 'Lisensi OctoFlow Enterprise untuk ruang kerja Anda tidak aktif. Hubungi administrator Anda untuk terus menggunakan OctoFlow.',
  rightTitle: 'Buka potensi penuh LLM',
  welcome: '👋 Selamat datang di OctoFlow, silakan login untuk melanjutkan.',
