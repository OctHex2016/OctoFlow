const translation = {
  ...
  welcome: 'به OctoFlow خوش آمدید، لطفا برای ادامه وارد شوید.',
  email: 'آدرس ایمیل',
  ...
  license: {
    tip: 'قبل از شروع OctoFlow Community Edition، GitHub را بخوانید',
    link: 'مجوز منبع باز',
  },
  join: 'عضویت',
  joinTipStart: 'شما را دعوت می‌کنیم به',
  joinTipEnd: 'تیم در OctoFlow',
  invalid: 'لینک منقضی شده است',
  explore: 'کاوش OctoFlow',
  ...
  resetPasswordDesc: 'ایمیلی را که برای ثبت نام در OctoFlow استفاده کرده اید تایپ کنید و ما یک ایمیل بازنشانی رمز عبور برای شما ارسال خواهیم کرد.',
  licenseInactive: 'مجوز غیر فعال',
  licenseLost: 'مجوز گم شده است',
  licenseExpired: 'مجوز منقضی شده است',
  licenseExpiredTip: 'مجوز OctoFlow Enterprise برای فضای کاری شما منقضی شده است. لطفا برای ادامه استفاده از OctoFlow با سرپرست خود تماس بگیرید.',
  licenseInactiveTip: 'مجوز OctoFlow Enterprise برای فضای کاری شما غیرفعال است. لطفا برای ادامه استفاده از OctoFlow با سرپرست خود تماس بگیرید.',
  licenseLostTip: 'اتصال سرور مجوز OctoFlow انجام نشد. لطفا برای ادامه استفاده از OctoFlow با سرپرست خود تماس بگیرید.',
  webapp: {
