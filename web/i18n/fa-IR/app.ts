const translation = {
  ...
  tracing: {
    ...
    aliyun: {
      title: 'نظارت بر ابر',
      description: 'پلتفرم مشاهده‌پذیری کاملاً مدیریت‌شده و بدون نیاز به نگهداری که توسط Alibaba Cloud ارائه شده، امکان نظارت، ردیابی و ارزیابی برنامه‌های OctoFlow را به‌صورت آماده و با تنظیمات اولیه فراهم می‌کند.',
    },
    tencent: {
      title: 'تنست ای‌پی‌ام',
