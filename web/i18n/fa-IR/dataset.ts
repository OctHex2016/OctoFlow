const translation = {
  ...
  intro1: 'دانش می‌تواند در برنامه OctoFlow ',
  ...
  externalAPIPanelDescription: 'API دانش خارجی برای اتصال به یک پایگاه دانش خارج از OctoFlow و بازیابی دانش از آن پایگاه دانش استفاده می شود.',
