const translation = {
  list: {
    title: 'اسناد',
    desc: 'تمامی فایل‌های دانش در اینجا نمایش داده می‌شوند و کل دانش می‌تواند به ارجاعات OctoFlow متصل شود یا از طریق افزونه چت ایندکس شود.',
    ...
    empty: {
      ...
      sync: {
        tip: 'OctoFlow به‌طور دوره‌ای فایل‌ها را از Notion شما دانلود و پردازش را کامل می‌کند.',
      },
    },
    delete: {
