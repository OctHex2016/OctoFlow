const translation = {
  ...
  welcome: 'Chào mừng bạn đến với OctoFlow, vui lòng đăng nhập để tiếp tục.',
  email: 'Địa chỉ email',
  ...
  license: {
    tip: 'Trước khi bắt đầu sử dụng Phiên bản Cộng đồng của OctoFlow, vui lòng đọc',
    link: 'Giấy phép mã nguồn mở trên GitHub',
  },
  join: 'Tham gia',
  joinTipStart: 'Mời bạn tham gia',
  joinTipEnd: 'đội ngũ tại OctoFlow',
  invalid: 'Liên kết đã hết hạn',
  explore: 'Khám phá OctoFlow',
  ...
  or: 'HOẶC',
  resetPasswordDesc: 'Nhập email bạn đã sử dụng để đăng ký trên OctoFlow và chúng tôi sẽ gửi cho bạn email đặt lại mật khẩu.',
  ...
  licenseInactiveTip: 'Giấy phép OctoFlow Enterprise cho không gian làm việc của bạn không hoạt động. Vui lòng liên hệ với quản trị viên của bạn để tiếp tục sử dụng OctoFlow.',
  licenseExpired: 'Giấy phép đã hết hạn',
  licenseExpiredTip: 'Giấy phép OctoFlow Enterprise cho không gian làm việc của bạn đã hết hạn. Vui lòng liên hệ với quản trị viên của bạn để tiếp tục sử dụng OctoFlow.',
  licenseLostTip: 'Không thể kết nối máy chủ cấp phép OctoFlow. Vui lòng liên hệ với quản trị viên của bạn để tiếp tục sử dụng OctoFlow.',
  webapp: {
