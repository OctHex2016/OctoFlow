const translation = {
  toVerifiedTip: {
    ...
    end: 'für den OctoFlow Professional Plan.',
  ...
  rejectTitle: 'Ihre OctoFlow-Ausbildungsüberprüfung wurde abgelehnt.',
  ...
  rejectContent: 'Leider sind Sie nicht für den Status "Education Verified" berechtigt und können daher den exklusiven 100%-Gutschein für den OctoFlow Professional Plan nicht erhalten, wenn Sie diese E-Mail-Adresse verwenden.',
  successContent: 'Wir haben einen 100% Rabattgutschein für den OctoFlow Professional Plan auf Ihr Konto ausgestellt. Der Gutschein ist ein Jahr lang gültig, bitte nutzen Sie ihn innerhalb des Gültigkeitszeitraums.',
  learn: 'Erfahren Sie, wie Sie Ihre Ausbildung überprüfen lassen.',
  emailLabel: 'Ihre aktuelle E-Mail',
  successTitle: 'Sie haben die OctoFlow-Ausbildung verifiziert',
  notice: {
    expired: {
      summary: {
        line1: 'Sie können weiterhin auf OctoFlow zugreifen und es nutzen.',
