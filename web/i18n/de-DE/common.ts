const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'OctoFlow-Konto',
    langGeniusAccountTip: 'Ihr OctoFlow-Konto und zugehörige Benutzerdaten.',
  ...
  members: {
    ...
    invitationSentTip: 'Einladung gesendet, und sie können sich bei OctoFlow anmelden, um auf Ihre Teamdaten zuzugreifen.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'Der OpenAI-Hostingdienst von OctoFlow ermöglicht es Ihnen, Modelle wie GPT-3.5 zu verwenden. Bevor Ihr Probe-Kontingent aufgebraucht ist, müssen Sie andere Modellanbieter einrichten.',
  ...
  apiBasedExtension: {
    title: 'API-Erweiterungen bieten zentralisiertes API-Management und vereinfachen die Konfiguration für eine einfache Verwendung in OctoFlows Anwendungen.',
  ...
  about: {
    ...
    nowAvailable: 'OctoFlow {{version}} ist jetzt verfügbar.',
    latestAvailable: 'OctoFlow {{version}} ist die neueste verfügbare Version.',
  },
  appMenus: {
    overview: 'Übersicht',
