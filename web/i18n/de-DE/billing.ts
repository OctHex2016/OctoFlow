const translation = {
  ...
  plansCommon: {
    ...
    ragAPIRequestTooltip: 'Bezieht sich auf die Anzahl der API-Aufrufe, die nur die Wissensdatenbankverarbeitungsfähigkeiten von OctoFlow aufrufen.',
    ...
    cloud: 'Cloud-Dienst',
    apiRateLimitTooltip: 'Die API-Datenbeschränkung gilt für alle Anfragen, die über die OctoFlow-API gemacht werden, einschließlich Textgenerierung, Chat-Konversationen, Workflow-Ausführungen und Dokumentenverarbeitung.',
    getStarted: 'Loslegen',
  ...
  plans: {
    ...
    enterprise: {
      ...
      features: [
        ...
        'SSO (Single Sign-On)',
        'Vereinbarte SLAs mit OctoFlow-Partnern',
        'Erweiterte Sicherheitsfunktionen und Kontrollen',
        'Offizielle Updates und Wartung durch OctoFlow',
    ...
    community: {
      ...
      features: [
        ...
        'Entspricht der OctoFlow Open-Source-Lizenz',
      ],
    },
    premium: {
