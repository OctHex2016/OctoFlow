const translation = {
  ...
  marketplace: {
    ...
    difyMarketplace: 'OctoFlow Marktplatz',
    moreFrom: 'Mehr aus dem Marketplace',
    pluginsResult: '{{num}} Ergebnisse',
    empower: 'Unterstützen Sie Ihre KI-Entwicklung',
    and: 'und',
    partnerTip: 'Von einem OctoFlow-Partner verifiziert',
    verifiedTip: 'Von OctoFlow überprüft',
  },
  task: {
  ...
  difyVersionNotCompatible:
    'Die aktuelle OctoFlow-Version ist mit diesem Plugin nicht kompatibel, bitte aktualisieren Sie auf die erforderliche Mindestversion: {{minimalOctoFlowVersion}}',
