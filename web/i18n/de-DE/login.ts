const translation = {
  ...
  welcome: 'Willkommen bei OctoFlow, bitte melde dich an, um fortzufahren.',
  ...
  license: {
    tip: 'Bevor du mit OctoFlow Community Edition beginnst, lies die',
    link: 'Open-Source-Lizenz',
  },
  join: 'Beitreten',
  joinTipStart: 'Lade dich ein, dem',
  joinTipEnd: 'Team auf OctoFlow beizutreten',
  invalid: 'Der Link ist abgelaufen',
  explore: 'OctoFlow erkunden',
  ...
  resetPasswordDesc: 'Geben Sie die E-Mail-Adresse ein, mit der Sie sich bei OctoFlow angemeldet haben, und wir senden Ihnen eine E-Mail zum Zurücksetzen des Passworts.',
  ...
  licenseLostTip: 'Fehler beim Verbinden des OctoFlow-Lizenzservers. Wenden Sie sich an Ihren Administrator, um OctoFlow weiterhin zu verwenden.',
  licenseInactive: 'Lizenz inaktiv',
  licenseInactiveTip: 'Die OctoFlow Enterprise-Lizenz für Ihren Arbeitsbereich ist inaktiv. Wenden Sie sich an Ihren Administrator, um OctoFlow weiterhin zu verwenden.',
  licenseExpiredTip: 'Die OctoFlow Enterprise-Lizenz für Ihren Arbeitsbereich ist abgelaufen. Wenden Sie sich an Ihren Administrator, um OctoFlow weiterhin zu verwenden.',
