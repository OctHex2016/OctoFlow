const translation = {
  tips: {
    ...
    notLoggedIn: 'Diese App möchte auf Ihr OctoFlow Cloud-Konto zugreifen',
    loggedIn: 'Diese App möchte auf die folgenden Informationen aus Ihrem OctoFlow Cloud-Konto zugreifen.',
