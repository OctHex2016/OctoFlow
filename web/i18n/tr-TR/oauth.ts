const translation = {
  tips: {
    notLoggedIn: 'Bu uygulama OctoFlow Cloud hesabınıza erişmek istiyor',
    ...
    loggedIn: 'Bu uygulama OctoFlow Cloud hesabınızdaki aşağıdaki bilgilere erişmek istiyor.',
