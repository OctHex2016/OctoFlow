const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'OctoFlow hesabı',
    langGeniusAccountTip: 'OctoFlow hesabınız ve ilişkili kullanıcı verileri.',
  ...
  members: {
    ...
    invitationSentTip: 'Davet gönderildi, OctoFlow\'ye giriş yaparak takım verilerinize erişebilirler.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      onTrial: 'DENEMEDE',
      exhausted: 'KOTA DOLU',
      desc: 'OctoFlow tarafından sağlanan OpenAI barındırma hizmeti, GPT-3.5 gibi modelleri kullanmanıza olanak tanır. Deneme kotanız bitmeden önce, diğer model sağlayıcılarını ayarlamanız gerekir.',
  ...
  apiBasedExtension: {
    title: 'API uzantıları merkezi API yönetimi sağlar, OctoFlow\'nin uygulamaları arasında kolay kullanım için yapılandırmayı basitleştirir.',
  ...
  about: {
    ...
    nowAvailable: 'OctoFlow {{version}} şimdi mevcut.',
    latestAvailable: 'OctoFlow {{version}} en son mevcut sürüm.',
  },
  appMenus: {
    overview: 'İzleme',
