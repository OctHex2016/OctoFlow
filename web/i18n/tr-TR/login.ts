const translation = {
  ...
  welcome: 'OctoFlow\'ye hoş geldiniz, devam etmek için lütfen giriş yapın.',
  ...
  license: {
    tip: 'OctoFlow Community Edition\'ı başlatmadan önce GitHub\'daki',
  ...
  resetPasswordDesc: 'OctoFlow\'a kaydolmak için kullandığınız e-postayı yazın, size bir şifre sıfırlama e-postası gönderelim.',
  ...
  back: 'Geri',
  licenseExpiredTip: 'Çalışma alanınız için OctoFlow Enterprise lisansının süresi doldu. OctoFlow\'ı kullanmaya devam etmek için lütfen yöneticinizle iletişime geçin.',
  licenseLostTip: 'OctoFlow lisans sunucusuna bağlanılamadı. OctoFlow\'ı kullanmaya devam etmek için lütfen yöneticinizle iletişime geçin.',
  licenseInactiveTip: 'Çalışma alanınız için OctoFlow Enterprise lisansı etkin değil. OctoFlow\'ı kullanmaya devam etmek için lütfen yöneticinizle iletişime geçin.',
