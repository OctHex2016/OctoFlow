const translation = {
  ...
  intro1: 'Bilgi, OctoFlow uygulamasına ',
  ...
  externalAPIPanelDescription: 'Harici bilgi API\'si, OctoFlow dışındaki bir bilgi bankasına bağlanmak ve bu bilgi bankasından bilgi almak için kullanılır.',
