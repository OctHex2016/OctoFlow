const translation = {
  ...
  plansCommon: {
    ...
    ragAPIRequestTooltip: 'OctoFlow\'nin sadece bilgi tabanı işleme yeteneklerini çağıran API çağrıları sayısını ifade eder.',
    ...
    apiRateLimitTooltip: 'OctoFlow API\'si aracılığıyla yapılan tüm isteklerde, metin oluşturma, sohbet konuşmaları, iş akışı yürütmeleri ve belge işleme dahil olmak üzere, API Oran Sınırı uygulanır.',
  ...
  plans: {
    ...
    enterprise: {
      ...
      features: {
        ...
        7: 'Resmi olarak OctoFlow tarafından Güncellemeler ve Bakım',
        0: 'Kurumsal Düzeyde Ölçeklenebilir Dağıtım Çözümleri',
        5: 'OctoFlow Partners tarafından müzakere edilen SLA\'lar',
      },
    ...
    community: {
      features: {
        1: 'Tek Çalışma Alanı',
        2: 'OctoFlow Açık Kaynak Lisansı ile uyumludur',
