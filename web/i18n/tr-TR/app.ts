const translation = {
  ...
  tracing: {
    ...
    aliyun: {
      ...
      description: 'Alibaba Cloud tarafından sağlanan tamamen yönetilen ve bakım gerektirmeyen gözlemleme platformu, OctoFlow uygulamalarının kutudan çıkar çıkmaz izlenmesi, takip edilmesi ve değerlendirilmesine olanak tanır.',
    },
    tencent: {
      title: 'Tencent APM',
