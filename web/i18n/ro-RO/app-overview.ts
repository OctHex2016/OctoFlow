const translation = {
  ...
  apiKeyInfo: {
    ...
    tryCloud: 'Sau încercați versiunea cloud a OctoFlow cu cotă gratuită',
  },
  overview: {
    ...
    appInfo: {
      ...
      settings: {
        ...
        more: {
          ...
          privacyPolicyTip: 'Ajută vizitatorii să înțeleagă datele pe care le colectează aplicația, consultați <privacyPolicyLink>Politica de confidențialitate</privacyPolicyLink> a OctoFlow.',
      ...
      embedded: {
        ...
        chromePlugin: 'Instalați extensia Chrome OctoFlow Chatbot',
        copied: 'Copiat',
        copy: 'Copiați',
      },
      qrcode: {
