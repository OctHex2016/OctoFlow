const translation = {
  ...
  welcome: 'Bine ai venit la OctoFlow, te rugăm să te autentifici pentru a continua.',
  ...
  license: {
    tip: 'Înainte de a începe OctoFlow Community Edition, citește',
    link: 'Licența open-source de pe GitHub',
  },
  join: 'Alătură-te',
  joinTipStart: 'Te invităm să te alături echipei',
  joinTipEnd: 'pe OctoFlow',
  invalid: 'Link-ul a expirat',
  explore: 'Explorează OctoFlow',
  ...
  or: 'SAU',
  resetPasswordDesc: 'Tastați e-mailul pe care l-ați folosit pentru a vă înscrie pe OctoFlow și vă vom trimite un e-mail de resetare a parolei.',
  changePasswordBtn: 'Setați o parolă',
  licenseLostTip: 'Nu s-a reușit conectarea serverului de licențe OctoFlow. Contactați administratorul pentru a continua să utilizați OctoFlow.',
  licenseInactive: 'Licență inactivă',
  licenseInactiveTip: 'Licența OctoFlow Enterprise pentru spațiul de lucru este inactivă. Contactați administratorul pentru a continua să utilizați OctoFlow.',
  licenseExpired: 'Licență expirată',
  licenseLost: 'Licență pierdută',
  licenseExpiredTip: 'Licența OctoFlow Enterprise pentru spațiul de lucru a expirat. Contactați administratorul pentru a continua să utilizați OctoFlow.',
  webapp: {
