const translation = {
  tips: {
    ...
    loggedIn: 'Această aplicație vrea să acceseze următoarele informații din contul tău OctoFlow Cloud.',
    notLoggedIn: 'Această aplicație vrea să acceseze contul tău OctoFlow Cloud',
