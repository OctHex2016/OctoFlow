const translation = {
  ...
  welcome: 'Bienvenido a OctoFlow, por favor inicia sesión para continuar.',
  ...
  resetPasswordDesc: 'Escriba el correo electrónico que utilizó para registrarse en OctoFlow y le enviaremos un correo electrónico de restablecimiento de contraseña.',
  ...
  licenseInactiveTip: 'La licencia de OctoFlow Enterprise para su espacio de trabajo está inactiva. Póngase en contacto con su administrador para seguir utilizando OctoFlow.',
  licenseExpired: 'Licencia caducada',
  licenseLost: 'Licencia perdida',
  licenseExpiredTip: 'La licencia de OctoFlow Enterprise para su espacio de trabajo ha caducado. Póngase en contacto con su administrador para seguir utilizando OctoFlow.',
  licenseLostTip: 'No se pudo conectar el servidor de licencias de Dife. Póngase en contacto con su administrador para seguir utilizando OctoFlow.',
  webapp: {
