const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'Cuenta OctoFlow',
    langGeniusAccountTip: 'Tu cuenta OctoFlow y los datos de usuario asociados.',
  ...
  members: {
    ...
    invitationSentTip: 'Invitación enviada, y pueden iniciar sesión en OctoFlow para acceder a tus datos del equipo.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'El servicio de hospedaje OpenAI proporcionado por OctoFlow te permite usar modelos como GPT-3.5. Antes de que se agote tu cuota de prueba, necesitas configurar otros proveedores de modelos.',
  ...
  apiBasedExtension: {
    title: 'Las extensiones basadas en API proporcionan una gestión centralizada de API, simplificando la configuración para su fácil uso en las aplicaciones de OctoFlow.',
  ...
  about: {
    ...
    nowAvailable: 'OctoFlow {{version}} ya está disponible.',
    latestAvailable: 'OctoFlow {{version}} es la última versión disponible.',
  },
  appMenus: {
    overview: 'Monitoreo',
    promptEng: 'Orquestar',
