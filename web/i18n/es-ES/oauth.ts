const translation = {
  tips: {
    ...
    notLoggedIn: 'Esta aplicación quiere acceder a su cuenta de OctoFlow Cloud',
    loggedIn: 'Esta aplicación quiere acceder a la siguiente información de su cuenta de OctoFlow Cloud.',
