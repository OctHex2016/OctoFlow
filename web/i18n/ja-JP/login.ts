const translation = {
  ...
  license: {
    tip: 'GitHub のオープンソースライセンスを確認してから、OctoFlow Community Edition を開始してください。',
    link: 'オープンソースライセンス',
  },
  join: '参加する',
  ...
  resetPasswordDesc: 'OctoFlow へのサインアップに使用したメールアドレスを入力すると、パスワードリセットメールが送信されます。',
  licenseLost: 'ライセンスを失った',
  licenseExpiredTip: 'ワークスペースの OctoFlow Enterprise ライセンスの有効期限が切れています。OctoFlow を引き続き使用するには、管理者に連絡してください。',
  licenseInactive: 'ライセンスが非アクティブです',
  licenseInactiveTip: 'ワークスペースの OctoFlow Enterprise ライセンスが非アクティブです。OctoFlow を引き続き使用するには、管理者に連絡してください。',
  licenseExpired: 'ライセンスの有効期限が切れています',
  licenseLostTip: 'OctoFlow ライセンスサーバーへの接続に失敗しました。続けて OctoFlow を使用するために管理者に連絡してください。',
  webapp: {
    login: 'ログイン',
