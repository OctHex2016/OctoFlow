const translation = {
  ...
  marketplace: {
    ...
    discover: '探索',
    and: 'と',
    difyMarketplace: 'OctoFlow マーケットプレイス',
    ...
    viewMore: 'もっと見る',
    verifiedTip: 'このプラグインは OctoFlow によって認証されています',
    partnerTip: 'このプラグインは OctoFlow のパートナーによって認証されています',
  },
  task: {
  ...
  difyVersionNotCompatible: '現在の OctoFlow バージョンはこのプラグインと互換性がありません。最小バージョンは{{minimalOctoFlowVersion}}です。',
  metadata: {
    title: 'プラグイン',
  },
