const translation = {
  ...
  workspace: {
    ...
    manageDescription: 'View and manage all your workspaces. You can rename or delete workspaces you own or administer.',
    current: 'Current',
    plan: 'Plan',
    renameWorkspace: 'Rename Workspace',
    deleteWorkspace: 'Delete Workspace',
    deleteWarning: 'This action will permanently delete the workspace and all its data.',
    deleteIsPermanent: 'This action cannot be undone. All apps, datasets, and settings will be permanently deleted.',
    deleteConfirmation: 'Are you sure you want to delete "{{name}}"?',
    cannotDeleteLastWorkspace: 'Cannot delete your last workspace.',
    typeWorkspaceNameToConfirm: 'Type the workspace name to confirm deletion:',
    enterWorkspaceName: 'Enter workspace name',
    switchToManage: 'Switch to this workspace to manage it',
  },
  errorMsg: {
  ...
  members: {
    ...
    invitationSentTip: 'Invitation sent, and they can sign in to OctoFlow to access your team data.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'The OpenAI hosting service provided by OctoFlow allows you to use models such as GPT-3.5. Before your trial quota is used up, you need to set up other model providers.',
  ...
  apiBasedExtension: {
    title: 'API extensions provide centralized API management, simplifying configuration for easy use across OctoFlow\'s applications.',
  ...
  about: {
    ...
    nowAvailable: 'OctoFlow {{version}} is now available.',
    latestAvailable: 'OctoFlow {{version}} is the latest version available.',
  },
  appMenus: {
    overview: 'Monitoring',
