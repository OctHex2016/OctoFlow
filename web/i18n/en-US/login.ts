const translation = {
  ...
  license: {
    tip: 'Before starting OctoFlow Community Edition, read the GitHub',
    link: 'Open-source License',
  },
  join: 'Join ',
  joinTipStart: 'Invite you join ',
  joinTipEnd: ' team on OctoFlow',
  invalid: 'The link has expired',
  explore: 'Explore OctoFlow',
  ...
  resetPasswordDesc: 'Type the email you used to sign up on OctoFlow and we will send you a password reset email.',
  ...
  licenseExpiredTip: 'The OctoFlow Enterprise license for your workspace has expired. Please contact your administrator to continue using OctoFlow.',
  licenseLost: 'License Lost',
  licenseLostTip: 'Failed to connect OctoFlow license server. Please contact your administrator to continue using OctoFlow.',
  licenseInactive: 'License Inactive',
  licenseInactiveTip: 'The OctoFlow Enterprise license for your workspace is inactive. Please contact your administrator to continue using OctoFlow.',
  webapp: {
    login: 'Login',
