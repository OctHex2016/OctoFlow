const translation = {
  ...
  plansCommon: {
    ...
    ragAPIRequestTooltip: 'Относится к количеству вызовов API, вызывающих только возможности обработки базы знаний OctoFlow.',
    ...
    apiRateLimitTooltip: 'Ограничение скорости API применяется ко всем запросам, сделанным через API OctoFlow, включая генерацию текста, чатовую переписку, выполнение рабочих процессов и обработку документов.',
  ...
  plans: {
    ...
    enterprise: {
      ...
      features: {
        4: 'ССО',
        5: 'Согласованные SLA от OctoFlow Partners',
        ...
        7: 'Обновления и обслуживание от OctoFlow официально',
    ...
    community: {
      features: {
        ...
        2: 'Соответствует лицензии OctoFlow с открытым исходным кодом',
