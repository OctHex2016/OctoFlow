const translation = {
  list: {
    title: 'Документы',
    desc: 'Здесь отображаются все файлы базы знаний, и вся база знаний может быть связана с цитатами OctoFlow или проиндексирована с помощью чата.',
    ...
    empty: {
      ...
      sync: {
        tip: 'OctoFlow будет периодически загружать файлы из вашего Notion и завершать обработку.',
      },
    },
    delete: {
