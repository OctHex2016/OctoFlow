const translation = {
  ...
  welcome: 'Bem-vindo ao OctoFlow, faça login para continuar.',
  ...
  license: {
    tip: 'Antes de começar a usar a Edição Comunitária do OctoFlow, leia a',
    link: 'Licença de código aberto do GitHub',
  },
  join: 'Participar',
  joinTipStart: 'Convidamos você a participar da',
  joinTipEnd: 'equipe no OctoFlow',
  invalid: 'O link expirou',
  explore: 'Explorar o OctoFlow',
  ...
  resetPasswordDesc: 'Digite o e-mail que você usou para se inscrever no OctoFlow e enviaremos um e-mail de redefinição de senha.',
  sendVerificationCode: 'Enviar código de verificação',
  usePassword: 'Usar senha',
  licenseInactiveTip: 'A licença do OctoFlow Enterprise para seu espaço de trabalho está inativa. Entre em contato com o administrador para continuar usando o OctoFlow.',
  licenseLostTip: 'Falha ao conectar o servidor de licenças OctoFlow. Entre em contato com o administrador para continuar usando o OctoFlow.',
  licenseExpired: 'Licença expirada',
  licenseLost: 'Licença perdida',
  licenseInactive: 'Licença inativa',
  licenseExpiredTip: 'A licença do OctoFlow Enterprise para seu espaço de trabalho expirou. Entre em contato com o administrador para continuar usando o OctoFlow.',
  webapp: {
