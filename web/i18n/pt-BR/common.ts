const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'Conta OctoFlow',
    langGeniusAccountTip: 'Sua conta OctoFlow e dados de usuário associados.',
  ...
  members: {
    ...
    invitationSentTip: 'Convite enviado e eles podem fazer login no OctoFlow para acessar os dados da sua equipe.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'O serviço de hospedagem OpenAI fornecido pela OctoFlow permite que você use modelos como GPT-3.5. Antes que sua cota de teste seja esgotada, você precisa configurar outros fornecedores de modelos.',
      callTimes: 'Chamadas',
  ...
  apiBasedExtension: {
    title: 'As extensões de API fornecem gerenciamento centralizado de API, simplificando a configuração para uso fácil em todos os aplicativos da OctoFlow.',
  ...
  about: {
    ...
    nowAvailable: 'OctoFlow {{version}} já está disponível.',
    latestAvailable: 'OctoFlow {{version}} é a última versão disponível.',
  },
  appMenus: {
