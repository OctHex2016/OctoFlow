const translation = {
  ...
  plansCommon: {
    ...
    ragAPIRequestTooltip: 'Refere-se ao número de chamadas de API que invocam apenas as capacidades de processamento da base de conhecimento do OctoFlow.',
    ...
    apiRateLimitTooltip: 'O limite da taxa da API se aplica a todas as solicitações feitas através da API OctoFlow, incluindo geração de texto, conversas de chat, execuções de fluxo de trabalho e processamento de documentos.',
  ...
  plans: {
    ...
    enterprise: {
      ...
      features: {
        7: 'Atualizações e manutenção por OctoFlow oficialmente',
        ...
        5: 'SLAs negociados pela OctoFlow Partners',
    ...
    community: {
      features: {
        ...
        2: 'Está em conformidade com a licença de código aberto OctoFlow',
      },
      name: 'Comunidade',
