const translation = {
  tips: {
    notLoggedIn: 'Este aplicativo quer acessar sua conta do OctoFlow Cloud',
    loggedIn: 'Este aplicativo quer acessar as seguintes informações da sua conta OctoFlow Cloud.',
