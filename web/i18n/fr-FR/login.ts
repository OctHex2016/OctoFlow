const translation = {
  ...
  welcome: 'Bienvenue sur OctoFlow, veuillez vous connecter pour continuer.',
  ...
  license: {
    tip: 'Avant de commencer OctoFlow Community Edition, lisez le GitHub',
    link: 'Licence Open-source',
  },
  join: 'Rejoindre',
  joinTipStart: 'Je vous invite à rejoindre',
  joinTipEnd: 'équipe sur OctoFlow',
  invalid: 'Le lien a expiré',
  explore: 'Explorez OctoFlow',
  ...
  resetPasswordDesc: 'Tapez l’adresse e-mail que vous avez utilisée pour vous inscrire sur OctoFlow et nous vous enverrons un e-mail de réinitialisation de mot de passe.',
  usePassword: 'Utiliser le mot de passe',
  licenseInactiveTip: 'La licence OctoFlow Enterprise de votre espace de travail est inactive. Veuillez contacter votre administrateur pour continuer à utiliser OctoFlow.',
  licenseLostTip: 'Échec de la connexion au serveur de licences OctoFlow. Veuillez contacter votre administrateur pour continuer à utiliser OctoFlow.',
  licenseExpired: 'Licence expirée',
  licenseLost: 'Licence perdue',
  licenseExpiredTip: 'La licence OctoFlow Enterprise de votre espace de travail a expiré. Veuillez contacter votre administrateur pour continuer à utiliser OctoFlow.',
