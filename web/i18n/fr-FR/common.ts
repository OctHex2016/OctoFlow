const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'Compte OctoFlow',
    langGeniusAccountTip: 'Votre compte OctoFlow et les données utilisateur associées.',
  ...
  members: {
    ...
    invitationSentTip: 'Invitation envoyée, et ils peuvent se connecter à OctoFlow pour accéder aux données de votre équipe.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'Le service d\'hébergement OpenAI fourni par OctoFlow vous permet d\'utiliser des modèles tels que GPT-3.5. Avant que votre quota d\'essai ne soit épuisé, vous devez configurer d\'autres fournisseurs de modèles.',
  ...
  apiBasedExtension: {
    title: 'Les extensions API fournissent une gestion centralisée des API, simplifiant la configuration pour une utilisation facile à travers les applications de OctoFlow.',
  ...
  about: {
    ...
    nowAvailable: 'OctoFlow {{version}} est maintenant disponible.',
    latestAvailable: 'OctoFlow {{version}} est la dernière version disponible.',
  },
  appMenus: {
