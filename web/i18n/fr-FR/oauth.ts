const translation = {
  tips: {
    ...
    notLoggedIn: 'Cette application veut accéder à votre compte OctoFlow Cloud',
    ...
    loggedIn: 'Cette application veut accéder aux informations suivantes de votre compte OctoFlow Cloud.',
  },
  scopes: {
    email: 'E-mail',
    name: 'Nom',
