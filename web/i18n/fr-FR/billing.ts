const translation = {
  ...
  plansCommon: {
    ...
    ragAPIRequestTooltip: 'Fait référence au nombre d\'appels API invoquant uniquement les capacités de traitement de la base de connaissances de OctoFlow.',
    ...
    apiRateLimitTooltip: 'La limite de taux de l\'API s\'applique à toutes les demandes effectuées via l\'API OctoFlow, y compris la génération de texte, les conversations de chat, les exécutions de flux de travail et le traitement de documents.',
  ...
  plans: {
    ...
    enterprise: {
      ...
      features: {
        ...
        5: 'SLA négociés par les partenaires OctoFlow',
        8: 'Assistance technique professionnelle',
        7: 'Mises à jour et maintenance par OctoFlow officiellement',
    ...
    community: {
      features: {
        ...
        2: 'Conforme à la licence Open Source OctoFlow',
      },
      name: 'Communauté',
