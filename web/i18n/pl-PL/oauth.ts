const translation = {
  tips: {
    ...
    notLoggedIn: 'Ta aplikacja chce uzyskać dostęp do twojego konta OctoFlow Cloud',
    ...
    loggedIn: 'Ta aplikacja chce uzyskać dostęp do następujących informacji z twojego konta OctoFlow Cloud.',
  },
  scopes: {
