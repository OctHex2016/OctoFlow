const translation = {
  ...
  welcome: 'Witaj w OctoFlow, zaloguj się, aby kontynuować.',
  email: 'Adres e-mail',
  ...
  license: {
    tip: 'Przed rozpoczęciem wersji społecznościowej OctoFlow, przeczytaj GitHub',
    link: 'Licencję open-source',
  },
  join: 'Dołącz',
  joinTipStart: 'Zapraszam Cię do dołączenia do',
  joinTipEnd: 'zespołu na OctoFlow',
  invalid: 'Link wygasł',
  explore: 'Odkryj OctoFlow',
  ...
  resetPasswordDesc: 'Wpisz adres e-mail, którego użyłeś do rejestracji w OctoFlow, a my wyślemy Ci wiadomość e-mail z prośbą o zresetowanie hasła.',
  or: 'LUB',
  ...
  licenseExpiredTip: 'Licencja OctoFlow Enterprise dla Twojego obszaru roboczego wygasła. Skontaktuj się z administratorem, aby kontynuować korzystanie z OctoFlow.',
  licenseLostTip: 'Nie udało się nawiązać połączenia z serwerem licencji OctoFlow. Skontaktuj się z administratorem, aby kontynuować korzystanie z OctoFlow.',
  licenseInactiveTip: 'Licencja OctoFlow Enterprise dla Twojego obszaru roboczego jest nieaktywna. Skontaktuj się z administratorem, aby kontynuować korzystanie z OctoFlow.',
  webapp: {
