const translation = {
  ...
  intro1: 'Wiedzę można zintegrować z aplikacją OctoFlow ',
  ...
  externalAPIPanelDescription: 'Interfejs API wiedzy zewnętrznej służy do łączenia się z bazą wiedzy poza OctoFlow i pobierania wiedzy z tej bazy wiedzy.',
  chunkingMode: {
