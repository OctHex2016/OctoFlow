const translation = {
  ...
  otherDataSource: {
    ...
    description: 'Obecnie baza wiedzy OctoFlow ma tylko ograniczone źródła danych. Dodanie źródła danych do bazy wiedzy OctoFlow to fantastyczny sposób na zwiększenie elastyczności i możliwości platformy dla wszystkich użytkowników. Nasz przewodnik po wkładach ułatwia rozpoczęcie pracy. Kliknij poniższy link, aby dowiedzieć się więcej.',
  },
  watercrawl: {
