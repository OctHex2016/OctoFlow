const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'Konto OctoFlow',
    langGeniusAccountTip: 'Twoje konto OctoFlow i powiązane dane użytkownika.',
  ...
  members: {
    ...
    invitationSentTip:
      'Zaproszenie zostało wysłane, a oni mogą zalogować się do OctoFlow, aby uzyskać dostęp do danych Twojego zespołu.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'Usługa hostowania OpenAI dostarczana przez OctoFlow pozwala korzystać z modeli takich jak GPT-3.5. Przed wyczerpaniem limitu próbnego należy skonfigurować inne dostawców modeli.',
  ...
  apiBasedExtension: {
    title:
      'Rozszerzenia oparte na interfejsie API zapewniają scentralizowane zarządzanie interfejsami API, upraszczając konfigurację dla łatwego użytkowania w aplikacjach OctoFlow.',
  ...
  about: {
    ...
    nowAvailable: 'OctoFlow {{version}} jest teraz dostępny.',
    latestAvailable: 'OctoFlow {{version}} jest najnowszą dostępną wersją.',
  },
  appMenus: {
