const translation = {
  toVerifiedTip: {
    ...
    end: 'dla Profesjonalnego Planu OctoFlow.',
  },
  form: {
    schoolName: {
    ...
    terms: {
      ...
      option: {
        ...
        inSchool: 'Potwierdzam, że jestem zapisany lub zatrudniony w podanej instytucji. OctoFlow może wymagać dowodu zapisania/zatrudnienia. Jeśli wprowadzę w błąd dotyczący mojej zdolności do uczestnictwa, zgadzam się zapłacić wszelkie opłaty, które zostały początkowo zaniechane w oparciu o mój status edukacyjny.',
      },
  ...
  submit: 'Zatwierdź',
  rejectContent: 'Niestety, nie kwalifikujesz się do statusu Zweryfikowanej Edukacji i w związku z tym nie możesz otrzymać ekskluzywnego kuponu 100% na plan OctoFlow Professional, jeśli korzystasz z tego adresu e-mail.',
  successContent: 'Wydaliśmy kupon rabatowy na 100% dla planu OctoFlow Professional na Twoje konto. Kupon jest ważny przez jeden rok, prosimy o jego użycie w okresie ważności.',
  currentSigned: 'AKTUALNIE ZALOGOWANY JAKO',
  successTitle: 'Masz zweryfikowane wykształcenie OctoFlow',
  rejectTitle: 'Twoja weryfikacja edukacyjna OctoFlow została odrzucona',
  ...
  notice: {
    expired: {
      summary: {
        line1: 'Możesz nadal uzyskać dostęp i korzystać z OctoFlow.',
